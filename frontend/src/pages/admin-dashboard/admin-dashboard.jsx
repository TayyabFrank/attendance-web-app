...
const AdminDashboard = () => {
  ...
  return (
    <div className="admin-dashboard">
      ...
      {expandedDept && (() => {
        let deptEmployees = employees.filter(emp => (emp.department || '').trim().toLowerCase() === (expandedDept || '').trim().toLowerCase());
        const totalEmployeesInDept = deptEmployees.length;
        ...
        return (
          <div className="modal-overlay" onClick={() => setExpandedDept(null)}>
            <div className="modal-content admin-modal" onClick={e => e.stopPropagation()} style={{ width: '500px', maxWidth: '90%' }}>
              <h3 className="modal-title">{expandedDept} Employees</h3>
              <button className="modal-close-btn" onClick={() => setExpandedDept(null)}>×</button>
                      ...
                      <div className="sleek-employee-list">
                        {deptEmployees.map(emp => (
                          <div 
                            key={emp.id} 
                            className="sleek-employee-row"
                            onClick={() => { setExpandedDept(null); setSelectedProfileEmployee(emp); }}
